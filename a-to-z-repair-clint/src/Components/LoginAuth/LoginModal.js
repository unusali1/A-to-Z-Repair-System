                ...
                <div className={newUser ? "cont s--signup" : "cont"}>
                    <div className="form sign-in">
                        ...
                        <form onSubmit={handleSignIn(onSubmit)}>
                            <label>
                                <span>Email</span>
                                <input placeholder='Enter your email' {...registerSignIn("email", { required: true })} type="email" />
                            </label>
                            <label>
                                <span>Password</span>
                                <input placeholder='Enter your password' {...registerSignIn("password", { required: true })} type="password" />
                            </label>
                    ...
                    <div className="sub-cont">
                        ...
                        <div className="form sign-up">
                            ...
                            <form onSubmit={handleSignUp(onSubmit)}>
                                <label>
                                    <span>Name</span>
                                    <input {...registerSignUp("name", { required: true })} type="text" value={message}
