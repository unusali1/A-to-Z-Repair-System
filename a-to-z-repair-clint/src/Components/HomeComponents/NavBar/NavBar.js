			...
			<Navbar
				...
				className={
					isSticky || isCollapsed
						? "slide in py-2 show shadow-sm navbar navbar-expand-md bg-white navbar-light   fixed-top"
						: "slide out show navbar navbar-expand-nd navbar-light py-2 fixed-top "
				}
			>
				<Container>
					...
					<Navbar.Collapse id="navbar-nav">
						<Nav className="ml-auto text-center">
							...
							<Nav.Link smooth as={HashLink} to="#about" className="mr-3">
								<strong>About</strong>
							</Nav.Link>
							<Nav.Link smooth as={HashLink} to="#service" className="mr-3">
								<strong>Service</strong>
							</Nav.Link>
							<Nav.Link smooth as={HashLink} to="#blog" className="mr-3">
								<strong>Blogs</strong>
							</Nav.Link>
							<Nav.Link smooth as={HashLink} to="#reviews" className="mr-3">
